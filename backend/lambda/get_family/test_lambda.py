...
def test_lambda_handler_success():
    ...
    event = {"pathParameters": {"study_id": "LFS", "family_id": "test_family_456"}}
    context = MagicMock()
...
def test_lambda_handler_not_found():
    ...
    event = {"pathParameters": {"study_id": "LFS", "family_id": "nonexistent_family"}}
    context = MagicMock()
...
def test_lambda_handler_error():
    ...
    event = {"pathParameters": {"study_id": "LFS", "family_id": "error_family"}}
    context = MagicMock()
