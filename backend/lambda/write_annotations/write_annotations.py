...
def write_annotations(family_id, data_str, bucket_name=None):
    ...
    try:
        ...
        logger.info(f"Successfully wrote annotations for family_id: {family_id}")
        return {"status": "success", "message": "Annotations written successfully"}
        
    except Exception as e:
        error_msg = f"Error writing annotations for family_id {family_id}: {str(e)}"
